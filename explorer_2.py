        ...
        while True:
            ...
            for d in 'ESNW':
                if d=='E':
                    ...
                    direction_1=2
                    if childcell in obstacles:
                        continue
                  #  if childcell not in obstacles and childcell not in explored:
                elif d=='S':
                ...
                beggin.append(childcell)
                direction=explored
                #print(irect)
                print('dir: ', direction)
                print('direction_indicated: ', direction_1)
        
                direction_random = random.randint(0, 7)
                if obstacles[direction_1] == VS.CLEAR:
                   return Explorer.AC_INCR[direction_1]
                   print(Explorer.AC_INCR[direction_1])
